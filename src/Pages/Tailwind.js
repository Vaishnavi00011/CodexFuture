    ...
    <div>
      ...
      <div className="bg-gray-50 min-h-screen p-4 sm:p-8">
        <header className="text-gray-900 py-6 px-2 pt-16 rounded-lg">
          <h1 className="text-3xl sm:text-4xl font-extrabold">Tailwind CSS Documentation</h1>
        ...
        <main className="mt-8 sm:mt-10 space-y-8 sm:space-y-10">
          <section>
            <h2 className="text-2xl sm:text-3xl font-semibold text-gray-800 border-b-2 border-teal-500 pb-2">
              Introduction
            </h2>
...
npx tailwindcss init`}
            ...
            <p className="text-gray-700 mt-4 text-sm sm:text-base">
              ...
              <code className="bg-gray-200 px-2 py-1 rounded text-xs sm:text-sm">
                tailwind.config.js
              </code>{' '}
              file to include the paths to your templates.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside mt-4 text-gray-700 space-y-2 text-sm sm:text-base">
              <li>
                <strong>Utility-first:</strong> Build designs directly in your markup using utility classes.
              </li>
              <li>
                <strong>Responsive Design:</strong> Tailwind includes built-in responsive design utilities.
              </li>
              <li>
                <strong>Customizability:</strong> Easily customize the framework to match your project’s design system.
              </li>
              <li>
                <strong>Flexbox and Grid:</strong> Powerful layout utilities for building modern designs.
              </li>
            </ul>
          </section>
    ...
    <button className="bg-teal-500 text-white py-2 px-4 rounded-lg shadow hover:bg-teal-600 transition">
      {label}
          ...
          <section>
            ...
            <ul className="list-disc list-inside mt-4 text-gray-700 space-y-2 text-sm sm:text-base">
              <li>
                <a href="https://tailwindcss.com/docs" className="text-teal-500 hover:underline">
                  Official Documentation
                </a>
              </li>
              <li>
                <a href="https://play.tailwindcss.com/" className="text-teal-500 hover:underline">
                  Tailwind CSS Playground
                </a>
              </li>
              <li>
                <a href="https://github.com/tailwindlabs/tailwindcss" className="text-teal-500 hover:underline">
                  GitHub Repository
                </a>
              </li>
            </ul>
